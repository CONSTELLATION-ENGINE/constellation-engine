...
Maintainers are responsible for clarifying and enforcing standards of acceptable behavior. They will take appropriate and fair corrective action in response to any behavior that they deem inappropriate, threatening, offensive, or harmful.
...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, project chat) and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers via [GitHub Private Vulnerability Reporting](https://github.com/CONSTELLATION-ENGINE/constellation-engine/security/advisories/new) or by opening a private discussion. All complaints will be reviewed and investigated promptly and fairly.
